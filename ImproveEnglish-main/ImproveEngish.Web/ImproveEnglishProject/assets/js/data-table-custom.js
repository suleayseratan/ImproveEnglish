$(document).ready(function () {
    setTimeout(function () {
        ...
        var srow = $('#row-select').DataTable({ "scrollX": "true" }
        );
        ...
        var drow = $('#row-delete').DataTable({ "scrollX": "true" });
        ...
        var drow1 = $('#dom-jqry').DataTable({ "scrollX": "true" }
        );
        ...
        var drow2 = $('#dom-jqry2').DataTable();
        $('#dom-jqry2 tbody').on('click', 'tr', function () {
            if ($(this).hasClass('selected')) {
                $(this).removeClass('selected');
            } else {
                drow2.$('tr.selected').removeClass('selected');
                $(this).addClass('selected');
            }
        });
        var drow3 = $('#dom-jqry3').DataTable();
        $('#dom-jqry3 tbody').on('click', 'tr', function () {
            if ($(this).hasClass('selected')) {
                $(this).removeClass('selected');
            } else {
                drow3.$('tr.selected').removeClass('selected');
                $(this).addClass('selected');
            }
        });
